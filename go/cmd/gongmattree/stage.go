...
func stageInjection() {
	...
	__Node__000004_child_2 := (&models.Node{Name: "child 2"}).Stage()
	__Node__000005_child_2_2 := (&models.Node{Name: "child 2.2"}).Stage()
	__Node__000006_child_2_3 := (&models.Node{Name: "child 2.3"}).Stage()
	...
	__Node__000004_child_2.Name = `child 2`
	__Node__000004_child_2.IsExpanded = true
	__Node__000004_child_2.HasCheckboxButton = true
	__Node__000004_child_2.IsChecked = false
	__Node__000004_child_2.IsCheckboxDisabled = false
	__Node__000004_child_2.HasAddChildButton = true
	__Node__000004_child_2.HasEditButton = true
	__Node__000004_child_2.IsInEditMode = false
	__Node__000004_child_2.HasDeleteButton = false

	// Node child 2.2 values setup
	__Node__000005_child_2_2.Name = `child 2.2`
	__Node__000005_child_2_2.IsExpanded = false
	__Node__000005_child_2_2.HasCheckboxButton = false
	__Node__000005_child_2_2.IsChecked = false
	__Node__000005_child_2_2.IsCheckboxDisabled = false
	__Node__000005_child_2_2.HasAddChildButton = true
	__Node__000005_child_2_2.HasEditButton = true
	__Node__000005_child_2_2.IsInEditMode = false
	__Node__000005_child_2_2.HasDeleteButton = false

	// Node child 2.3 values setup
	__Node__000006_child_2_3.Name = `child 2.3`
	__Node__000006_child_2_3.IsExpanded = false
	__Node__000006_child_2_3.HasCheckboxButton = false
	__Node__000006_child_2_3.IsChecked = false
	__Node__000006_child_2_3.IsCheckboxDisabled = false
	__Node__000006_child_2_3.HasAddChildButton = false
	__Node__000006_child_2_3.HasEditButton = true
	__Node__000006_child_2_3.IsInEditMode = false
	__Node__000006_child_2_3.HasDeleteButton = false
	...
	__Node__000004_child_2.Children = append(__Node__000004_child_2.Children, __Node__000005_child_2_2)
	__Node__000004_child_2.Children = append(__Node__000004_child_2.Children, __Node__000006_child_2_3)
	__Tree__000000_Tree_1.RootNodes = append(__Tree__000000_Tree_1.RootNodes, __Node__000004_child_2)
