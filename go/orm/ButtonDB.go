...
// BackRepoButton.Init set up the BackRepo of the Button
func (backRepoButton *BackRepoButtonStruct) Init(db *gorm.DB) (Error error) {

	if backRepoButton.Map_ButtonDBID_ButtonPtr != nil {
		err := errors.New("In Init, backRepoButton.Map_ButtonDBID_ButtonPtr should be nil")
		return err
	}

	if backRepoButton.Map_ButtonDBID_ButtonDB != nil {
		err := errors.New("In Init, backRepoButton.Map_ButtonDBID_ButtonDB should be nil")
		return err
	}

	if backRepoButton.Map_ButtonPtr_ButtonDBID != nil {
		err := errors.New("In Init, backRepoButton.Map_ButtonPtr_ButtonDBID should be nil")
		return err
	}

	tmp := make(map[uint]*models.Button, 0)
	backRepoButton.Map_ButtonDBID_ButtonPtr = &tmp

	tmpDB := make(map[uint]*ButtonDB, 0)
	backRepoButton.Map_ButtonDBID_ButtonDB = &tmpDB

	tmpID := make(map[*models.Button]uint, 0)
	backRepoButton.Map_ButtonPtr_ButtonDBID = &tmpID

	backRepoButton.db = db
	return
}
...
func (backRepoButton *BackRepoButtonStruct) CheckoutPhaseOne() (Error error) {
	...
	for key, value := range models.Stage.Buttons {
